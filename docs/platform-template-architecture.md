...
The shared layer now lives in `src/platform/`.
...
Read-only reference used for the first extracted contract:
...
1. Add or update the product entry in `src/platform/catalog/products.ts`
